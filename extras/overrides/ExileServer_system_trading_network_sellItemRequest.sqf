...
try 
{
	...
	if (_logging isEqualTo 1) then
	{
		...
		// Log transactions
		_traderLog = format ["PLAYER: ( %6 ) %1 SOLD ITEM: %5 FOR %2 POPTABS AND %3 RESPECT | PLAYER TOTAL MONEY: %4",_playerObject,_sellPrice,_respectGain,_playerMoneyString,_itemClassName,getPlayerUID _playerObject];
		['A3_EXILE_TRADERLOG',_traderLog] call FNC_A3_CUSTOMLOG;
	};
